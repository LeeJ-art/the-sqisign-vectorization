...
int
dim2id2iso_ideal_to_isogeny_clapotis_bench(quat_alg_elem_t *beta1,
                                     quat_alg_elem_t *beta2,
                                     ibz_t *u,
                                     ibz_t *v,
                                     ibz_t *d1,
                                     ...
                                     ec_basis_t *basis,
                                     const quat_left_ideal_t *lideal,
                                     const quat_alg_t *Bpoo, uint64_t(*ttime)[1000], uint64_t bench)
{
    quat_alg_elem_t mu1, mu2, small, theta, elem, apply_to_basis;
    ibz_t tmp;
    ec_basis_t E0_basis, B2, B1, to_be_pushed;
...
int dim2id2iso_arbitrary_isogeny_evaluation_bench(ec_basis_t *basis, ec_curve_t *codomain, const quat_left_ideal_t *lideal, uint64_t(*ttime)[1000], uint64_t bench)
{
    int ret;
    ...
    ret = dim2id2iso_ideal_to_isogeny_clapotis_bench(
        &beta1, &beta2, &u, &v, &d1, &d2, codomain, basis, lideal, &QUATALG_PINFTY, ttime, bench);
