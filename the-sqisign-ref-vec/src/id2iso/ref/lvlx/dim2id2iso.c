                                     ...
                                     const quat_alg_t *Bpoo)
{
    ...
    // norm d1,d2 equivalent to ideal /* I_1, I_2 */
    // beta1 and beta2 are elements of norm nd1,
    ...
    theta_couple_point_t P, Q, PmQ; /*P = (P1,P2), P1 = x_(real, img), z_(real, img)*/
